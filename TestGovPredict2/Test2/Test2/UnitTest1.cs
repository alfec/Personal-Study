...
namespace Test2
{
    ...
    public class UnitTest1
    {
        ...
        public void SelectEmoji()
        {
            ...
            var text = browser.FindElement(By.XPath("//html/body/div[4]/div/div")).Text;
            Assert.AreEqual(text, "Grinning face");
        }
        ...
        public void ValidateCount()
        {
            ...
            Assert.AreEqual(count, "Characters : 29");
        }
        ...
        public void ScreenShot(String x)
        {
            ...
            string shot = "C:\\Users\\bogola\\Desktop\\Automação\\TesteGovPredict2\\Test2\\Test2\\prints\\prints_" + x + y + ".png";
